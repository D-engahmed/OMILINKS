"""Alembic env: async engine + autogenerate against app metadata."""
...
import app.domains.tenants.models.plan  # noqa: F401
import app.domains.access.models.rbac  # noqa: F401
